 ...
 */
function requestChartCaptureFromBrowser(tvSymbol, timeoutMs = 22000, marketTimeframes) {
    ...
    return new Promise((resolve, reject) => {
        const timer = setTimeout(() => {
            ...
            reject(new Error("截图超时：请在本机浏览器打开 Argus 页面并保持标签页在前台（WebSocket 已连接），收盘时会调用 TradingView 截图。"));
        }, timeoutMs);
