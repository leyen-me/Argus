import { customType, double, index, int, longtext, mysqlTable, primaryKey, tinyint, varchar, } from "drizzle-orm/mysql-core";
...
export const promptStrategies = mysqlTable("prompt_strategies", {
...
export const agentSessionMessages = mysqlTable("agent_session_messages", {
...
export const dashboardEquitySamples = mysqlTable("dashboard_equity_samples", {
