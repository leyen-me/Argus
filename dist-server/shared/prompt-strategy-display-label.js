 ...
 */
export function formatPromptStrategyDisplayLabel(strategyId, rawLabel) {
    const id = String(strategyId ?? "").trim();
    const label = String(rawLabel ?? "").trim();
    if (!label)
        return "未命名策略";
    if (label === id && STRATEGY_UUID_V4_RE.test(id))
        return "未命名策略";
    return label;
}
//# sourceMappingURL=prompt-strategy-display-label.js.map