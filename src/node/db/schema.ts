...
export const agentSessions = mysqlTable(
  "agent_sessions",
  {
    ...
    llmTotalTokens: int("llm_total_tokens"),
    llmStartedAt: varchar("llm_started_at", { length: 32 }),
    llmEndedAt: varchar("llm_ended_at", { length: 32 }),
    llmDurationMs: int("llm_duration_ms"),
    updatedAt: varchar("updated_at", { length: 32 }).notNull(),
